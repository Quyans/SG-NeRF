...
class NeuralPointsRayMarching(nn.Module):
    ...
    def forward(self,
        ...
        # ray march
        # out =  torch.logical_not(torch.any(ray_valid, dim=-1, keepdims=True)).repeat(1, 1, 3).to(torch.float32)
        # return out
