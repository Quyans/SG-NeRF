...
class BPNet(nn.Module):
    ...
    def forward(self, sparse_3d, images, links):
        ...
        # x = self.layer0_2d.cpu()(data_2d.cpu())  # 1/4
        ...
        # 3D feature extract
        # out_p1 = self.layer0_3d.cpu()(sparse_3d)
        # out_b1p2 = self.layer1_3d.cpu()(out_p1)
        # out_b2p4 = self.layer2_3d.cpu()(out_b1p2)
        # out_b3p8 = self.layer3_3d.cpu()(out_b2p4)
        # out_b4p16 = self.layer4_3d.cpu()(out_b3p8)  # corresponding to FPN p5
