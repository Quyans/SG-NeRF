...
files = sorted(glob.glob('/home/vr717/Documents/qys/code/NSEPN_ori/NSEPN/data_src/scannet/scans/scene0113/*/*_vh_clean_2.ply'))
files2 = sorted(glob.glob('/home/vr717/Documents/qys/code/NSEPN_ori/NSEPN/data_src/scannet/scans/scene0113/*/*_vh_clean_2.labels.ply'))
assert len(files) == len(files2)
print("fuck")
p = mp.Pool(processes=mp.cpu_count())
p.map(f, files)
